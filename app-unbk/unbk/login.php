...
<head>
        ...
        <link href="css/css/selectbox.min.css" rel="stylesheet">
                            ...
                            <form action="konfirm.php" class="login-form" method="post" accept-charset="utf-8" id="form1" data-toggle="validator">
                                ...
                                <script src="mesin/jss/jquery.min.js"></script>
                                        ...
                                        <div class="form-group">
                                            <div class="col-xs-12">
                                                <button type="submit" class="btn btn-primary doblockui" onClick="validateAndSend()" style="border-radius: 30px; font-family: sans-serif;">LOGIN</button>
                                            </div>
...
<footer>
    <div class="container-fluid">
        <div class="row no-gutters">
            <div class="col-md-12">
                <div class="copyright">v10.05.2020 - Copyrights Kemdikbud © 2021</div>
            </div>
        </div>
    </div>
</footer>
