...
$str = str_replace("'<","`<",$str);
	...
	echo "<img src='pictures/$result[XGambarTanya]' width='250px'></a><br /><br />";}
	echo "</p>";

?>

						<div class="modal fade bs-modal-lg in" id="myModalP" role="dialog">
							<div class="modal-dialog modal-lg" style="width:50%"><br><br><br><br><br>
									<div class="col-md-12">
 ...
 if(isset($XE)){ $nilaiE = $var_ragu['$XE']; }
   ...
   ?>
    ...
    <div >
                   ...
                   <?php 
				   $cekragu = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'
				   and XUserJawab = '$user'")); 
 					  	if($cekragu>0){ ?>
