...
<?php						  	
 $sqlubah = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_tes (tes) values ('cuk')");
 $sqlubah = mysqli_query($GLOBALS["___mysqli_ston"], "update cbt_ujian set XStatusUjian = '0'");
								$sqlujian = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XKodeSoal = '$_REQUEST[txt_ujian]'");
...
// Ambil Paket Soal
//=========================
$loop = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_paketsoal where XStatusSoal ='Y'");
...
$jumsoal = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_paketsoal where  XKodeSoal = '$_REQUEST[txt_ujian]'"));
