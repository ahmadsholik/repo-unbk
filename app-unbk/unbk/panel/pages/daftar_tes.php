...
<body>
                ...
                <div class="portlet light ">
                                <div class="portlet-title">
									...
									<div class="actions">
										<a href="?modul=aktifkan_jadwaltes&hasiltampil&urut=<?php echo $ss[Urut]; ?>">													
                                        <?php if($sttsh=="0"){ ?>
										...
										<a href="?modul=aktifkan_jadwaltes&statustoken&urut=<?php echo $ss[Urut]; ?>">													
                                        <?php if($stts=="0"){ ?>
		...
		//tampildata();
                                    ...
                                    <tr class="odd gradeX">
										...
										<td align='center'>"; if(($s['XStatusUjian']=="0"||$s['XStatusUjian']=="9")||($tglsekarang>$tglujian||$sekarang > $jamhabis)){ echo"
											...
											<?php } elseif($tglsekarang==$tglujian&&$sekarang < $time1){ ?> <input type="button" id="selesai<?php echo $s['Urutan']; ?>" class="btn btn-default" value="Segera"  <?php echo $katapakai.">"; } else { ?>
											<input type="button" id="selesai<?php echo $s['Urutan']; ?>" class="btn btn-info" value="Aktif" <?php echo $katapakai; ?>>
											<?php } ?></td>     
