...
<body style="width:100%; margin:0 auto;margin-top:50px; ">
...
$sqlujian = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian c left join cbt_mapel m on m.XKodeMapel = c.XKodeMapel where c.XKodeSoal = '$var_soal' and c.XTokenUjian = '$var_token'"); 
      ...
      <div class="right">
      					...
      					<div class="panel panel-default">
                                          ...
                                          <div class="panel-body">
							                ...
							                <div style="font-size:64px" id="nilaiskor"> <?php echo $total_nilai; ?></div></td>
              								</tr>
                                            </table>    
                                          </div>
                         </div>
