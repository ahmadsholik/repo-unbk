...
<div class="group">
    <div class="left">
				...
				<div class="panel panel-info" style="padding-top:20">
                        ...
                        <div id="upload3" style="text-align:center"><img src="images/<?php echo "$skullogin"; ?>" width="150"/></div><span id="status" ></span>
                        <ul id="files"></ul>
           				</div>
               			<div class="panel-footer" style=" text-align:center">Klik Gambar untuk Ganti Gambar<br>File : jpg, gif, png ; 760x860 pixel
                        </div>
                ...
                <div class="panel panel-info" style="padding-top:20">
                        ...
                        <!-- Upload Button, use any id you wish-->
                        <div id="upload1" style="text-align:center"><img src="../../images/<?php echo "$skulban"; ?>" height="200px"/></div><span id="status1" ></span>
                        <ul id="files1"></ul>
           				</div>
               			<div class="panel-footer" style=" text-align:center">Klik Gambar untuk Ganti Banner
                        <br/>Ukuran Banner 315x101 pixel</div>
