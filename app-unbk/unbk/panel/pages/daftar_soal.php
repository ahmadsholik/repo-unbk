                       ...
                       Download File Excel (Template Soal)
                        ...
                        <div class="panel-body">
							...
							<div style="width: 90%; float:left">
							   <h5>Silahkan Klik tombol template dibawah, untuk <a href="../../file-excel/bee_soal_temp.xls" target="_blank"> download </a> file excel template soal sesuai dengan pilihannya. 
...
<div class="modal fade" id="myCopy<?php echo $s['Urutan']; ?>" tabindex="" role="dialog" aria-labelledby="myModalLabel"  > 
...
<!-- Modal -->
				...
				<div class="modal fade" id="petunjuk" role="dialog" tabindex="-1" aria-label="petunjukLabel">
					<div class="modal-dialog" role="document">
						<div class="modal-content">
						<div class="modal-header" style="background-color:#CECEBF">
							<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="false">&times;</span></button>
							<h4 >Keterangan</h4></div>
                        
                        <div class="modal-body" style="background-color:#CBE7E7">
						
						<?php include "petunjuk.php";?>
...
<script>
	$('#petunjuk').on('shown.bs.modal', function () {
	  $('#petunjuk').focus()
	})
