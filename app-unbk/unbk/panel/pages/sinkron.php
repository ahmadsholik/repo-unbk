...
<br> 
	...
	<?php include "../../config/server_pusat.php";
		$sync = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_sinc where XServerId='$serverid'");
		if ($sync == TRUE){
...
//document.getElementById("information").innerHTML="  Sikronisasi : DATA 1 ... <b>'.$i.'</b> dari <b>'. $baris.'</b> Selesai.";
		...
		if ($sinch == TRUE){
					...
					$sina = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}
		}
		}
?>
...
//document.getElementById("information").innerHTML="  Sikronisasi : DATA 2 ... <b>'.$i.'</b> dari <b>'. $baris.'</b> Selesai.";
		...
		if ($sinch == TRUE){
					...
					$sinb = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}			
		}
		}
?>
...
//			document.getElementById("information2").innerHTML="  Sikronisasi : DATA 4 ... <b>'.$i.'</b> dari <b>'. $baris.'</b> Selesai.";			
		...
		if ($sinch == TRUE){
					...
					$sind = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}		
		}
} ?>
...
$i = 1;
		...
		while($r=mysqli_fetch_array($sqlcek)){
					...
					$query =  mysqli_query($GLOBALS["___mysqli_ston"], "INSERT INTO cbt_mapel ( 
		...
		if ($sinch == TRUE){
					...
					$sine = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}		
		}
		}	?>
...
// Javascript for updating the progress bar and information
		...
		if ($sinch == TRUE){
					...
					$sinf = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}		
		}
}
?>
...
// Javascript for updating the progress bar and information
		...
		if ($sinch == TRUE){
					...
					$sing = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='1' where XServerId='$serverid'");
		}
		}
}
?>
...
// Javascript for updating the progress bar and information
	...
	include "../../config/server_pusat.php";
		...
		if ($sinch == TRUE){
					...
					$sinc9 = mysqli_query($GLOBALS["___mysqli_ston"], "UPDATE server_sekolah SET XStatusSinc='2' where XServerId='$serverid'");
		}
		}
}
?>
