...
if(isset($_REQUEST['simpan'])){
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "update server_sekolah set XServerId = '$_REQUEST[txt_kodsek]', XSekolah = '$_REQUEST[txt_namsek]', XAlamatSek = '$_REQUEST[txt_alsek]' where Urut = '$_REQUEST[urut]'");
}
...
$sqlcek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from server_sekolah where XServerId = '$_REQUEST[txt_kodsek]'"));
	...
	echo "<script type='text/javascript'>alert('$message');</script>";
		...
		$sql = mysqli_query($GLOBALS["___mysqli_ston"], "insert into server_sekolah (XServerId, XSekolah, XAlamatSek, XStatus) values  
                            ...
                            <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
								...
								?>
                                    ...
                                    <tr class="odd gradeX">
										...
										if ($s['XStatusSinc']==0){
												echo "<b>Belum";
											}elseif($s['XStatusSinc']==2){
												echo "Sukses";
											}elseif($s['XStatusSinc']==1) {
												echo "Sedang Proses";
											}
										?>
										<td align="center"><a href="?modul=data_skul&reset&server=<?php echo $s['XServerId']; ?>">
