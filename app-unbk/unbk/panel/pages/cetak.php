...
<?php
//koneksi database
//($GLOBALS["___mysqli_ston"] = mysqli_connect("localhost",  "root",  "", NULL, 3307));
//mysqli_select_db($GLOBALS["___mysqli_ston"], cbt);//fungsi pagination
...
$kolom = 2;
$i = 0;
$query = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cbt_siswa LIMIT $MulaiAwal , $BatasAwal");
