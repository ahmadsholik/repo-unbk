...
$sqljumlahx = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(XNilaiEsai) as hasil from cbt_jawaban where XKodeSoal = '$_REQUEST[soal]' and XUserJawab = '$_REQUEST[siswa]' and XTokenUjian = '$var_token'");
...
<div class="group">
    <div class="left">
      ...
      <div class="right"><div class="panel panel-default">
                ...
                <div style="font-size:64px" id="nilaiskor"><?php echo $nilaiawal; ?></div></td>
              </tr>
