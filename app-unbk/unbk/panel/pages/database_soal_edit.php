...
$id=$_REQUEST['nomer'];
$sqlambil = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_paketsoal where XKodeSoal = '$_REQUEST[soal]'  and Urut = '$id'");
...
<?php
$sql0 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal= '$_REQUEST[soal]'");
?>
