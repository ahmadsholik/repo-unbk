...
include "../../config/server.php";
	...
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa WHERE XNomerUjian='$_COOKIE[beeuser]'");
    				...
    				<div class="panel panel-primary">
                        ...
                        <div class="panel-body">
							...
							<tr height="42px"><td width="30%">Mapel Pilihan/Non Pilihan&nbsp;</td><td>: <td>
								...
								<?php $x= mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_mapel where XMapelAgama='Y'");
