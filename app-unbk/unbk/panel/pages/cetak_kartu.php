...
<div class="portlet light ">
	...
	<div class="">
		<iframe src="<?php echo "print_kartu.php?kelas=$_REQUEST[iki2]&jur=$_REQUEST[jur2]"; ?>" style="display:yes;" name="frame" scrolling="auto" width="100%" height="500px" frameborder="0"></iframe> </div>
</div>
</body>
</html>