...
include "../../config/server.php";					  	
 ...
 $sqlubah2 = mysqli_query($GLOBALS["___mysqli_ston"], "update cbt_ujian set XStatusUjian = '0'");
...
$jumsoal = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_paketsoal where  XKodeSoal = '$s[txt_ujian]'"));
