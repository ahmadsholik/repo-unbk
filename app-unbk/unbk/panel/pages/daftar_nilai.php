...
$sqlsiswa = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa where XNomerUjian= '$user' ");
...
<?php 
$sqladmin = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_nilai where XNomerUjian= '$user'"));
if($sqladmin<1){
$no=1;	
$usernm="-";	
$ku="-"; 
...
$query=mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM cbt_nilai where XNomerUjian= '$user'");
...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_mapel where XKodeMapel = '$var[XKodeMapel]' ");
