...
if(isset($_REQUEST['upl'])){ 
	$sqlnilai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_nilai where XTokenUjian = '$_REQUEST[token]' AND XStatus='1'");
...
?>                            
                        ...
                        <div class="panel-body">
                            <table width="100%" class="table table-striped table-bordered table-hover">
                                ...
                                <?php   
								include "../../config/server.php";
								$sql5 = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT n.*,s.*,k.*,s.XKodeKelas as XKodeKelas, n.XNomerUjian as XNomerUjian
...
function toggle(pilih) {
  ...
  for(var i=0, n=checkboxes.length;i<n;i++) {
    checkboxes[i].checked = pilih.checked;
                            ...
                            <!-- /.table-responsive -->
                            <div class="well">
                                <h4>CBT DAFFAMEDIA</h4>
                                <p>Untuk keterangan lebih lanjut Hubungi : TUWAGAPAT STUDIO - CBT DAFFAMEDIA  087859216448</p><p>
                                </p>
                            </div>
                        </div>
                        <!-- /.panel-body -->
