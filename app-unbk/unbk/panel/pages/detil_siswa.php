                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
								...
								if(isset($_REQUEST['beeuser'])){
									$siswa = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $_REQUEST['beeuser']);
									$sql = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa where XNomerUjian = '$_REQUEST[beeuser]'");
