...
if(isset($_REQUEST['token'])){
		...
		$sql = mysqli_query($GLOBALS["___mysqli_ston"], "select su.*,s.*,su.urut as yoi,u.XKodeMapel,m.XNamaMapel from cbt_siswa_ujian su left join cbt_siswa s on s.XNomerUjian=su.XNomerUjian
