...
<button type="button" class="btn btn-default btn-sm" onClick="frames['frame'].print()" style="margin-top:5px; margin-bottom:5px"><i class="glyphicon glyphicon-print"></i> Print 
</button> 
...
for($i=1;$i<=$n;$i++){ ?>
    ...
    <tr>
								...
								if($_REQUEST['tes3']=='A'){$namaujian = "DAFTAR NILAI UJIAN ";} else {$namaujian = "DAFTAR NILAI TRYOUT";}
								?>                                
...
$sto1 = mysqli_query($GLOBALS["___mysqli_ston"], "
...
$sto2 = mysqli_query($GLOBALS["___mysqli_ston"], "
...
$sto3 = mysqli_query($GLOBALS["___mysqli_ston"], "
...
$sto4 = mysqli_query($GLOBALS["___mysqli_ston"], "
...
$sto5 = mysqli_query($GLOBALS["___mysqli_ston"], "
