                ...
                <div class="col-md-12">
                            <div class="portlet light ">
                                <div class="portlet-title">
									...
									<div class="actions">
										<a href="../../file-excel/bee_tugas_temp.xls" target="_blank">
											<button class="btn btn-success btn-small" id="baru" value="Buat" name="baru"><i class="fa fa-file-excel-o"></i>
											Download</button>
										</a>
...
// $xlevel = str_replace("'","\'",$xlevel);
 ...
 $xlevel = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $xlevel);
 $xkelas = mysqli_real_escape_string($GLOBALS["___mysqli_ston"], $xkelas);
