...
$skull= "UJIAN BERBASIS KOMPUTER";
	...
	$h2="INDONESIA EDUCATION PARTNER";
	$h3="CBT Login";	
	$hakakses="0";
	$loginpanel="0";
                    ...
                    <div class="mt-element-ribbon bg-grey-steel">
						...
						<h5><?php echo "Web : ".$web." &nbsp;-&nbsp; Telp : ".$tlp; ?><!--<br><?php echo "Email: ".$email; ?>!--></h5>
									...
									<div class="login-content" style="margin-top:15%">
															<h1><?php echo "$h3"; ?> </h1>
															<p> Selamat datang di Admin Panel CBTSync , Silahkan Masukan username dan password untuk login ke halaman administrator. </p>
                    ...
                    <div class="login-footer">
                        <div class="row bs-reset">
                            ...
                            <div class="col-xs-7 bs-reset">
								...
								<p>Kemdikbud - Copyright &copy; 2021 &nbsp;<a href="#">. </a> </p>
                                </div>
                            </div>
                        </div>
                    </div>
