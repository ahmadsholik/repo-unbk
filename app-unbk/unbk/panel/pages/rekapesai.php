...
function Header(){
	...
	$sqlmapel = mysqli_query($GLOBALS["___mysqli_ston"], "select * from  cbt_mapel where XKodeMapel = '$_REQUEST[mapel]'"); 	
...
$hasil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT *,u.XStatusUjian as ujsta,u.XTokenUjian as tokek, u.XNomerUjian as NU, c.XKodeMapel as Kopel, u.XKodeSoal as Koso, c.XSesi as seksi, s.XKodeJurusan as SJur,s.XKodeKelas as SKel
FROM cbt_siswa s
...
while($d=mysqli_fetch_array($hasil)){
	...
	$listjawab = mysqli_query($GLOBALS["___mysqli_ston"], $sqljawab." order by XNomerSoal");
