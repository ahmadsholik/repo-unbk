...
com.wiris.js.JsPluginViewer.prototype = {
	...
	,callService: function(mml,servicename) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 589, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 591, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
		con.open("POST",url,false);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		con.send(data);
		return con.responseText;
	}
	,callShowimage: function(mml,img,callbackFunc) {
		var _g = this;
		var con;
		var height = 0;
		var width = 0;
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 473, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("GET:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 475, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		con.open("GET",url + data,true);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		var onloadFunc = function(e) {
			var getResultFunc = function(e1) {
				...
				if(result.height > 0) {
					if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(_g.calculateAlignment(height,baseline),{ fileName : "JsPluginViewer.hx", lineNumber : 495, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
			...
			if(haxe.Json.parse(con.responseText).status == "warning") {
				...
				con.onerror = function(e1) {
					if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("ShowImage call failed!",{ fileName : "JsPluginViewer.hx", lineNumber : 546, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
				};
				con.send(data);
		...
		con.onerror = function(e) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("ShowImage call failed!",{ fileName : "JsPluginViewer.hx", lineNumber : 565, className : "com.wiris.js.JsPluginViewer", methodName : "callShowimage"});
		};
		con.send(null);
	}
	...
	,processMathML: function(mml,container,callbackFunc) {
		...
		if(this.mode == com.wiris.js.JsPluginViewer.USE_CREATE_IMAGE && this.performanceenabled) this.callShowimage(mml,img,callbackFunc); else if(this.mode == com.wiris.js.JsPluginViewer.USE_CREATE_IMAGE && !this.performanceenabled) this.callCreateImage(mml,img); else img.src = this.baseURL + this.localpath + "/showimage" + this.extension + "?mml=" + StringTools.urlEncode(mml);
	...
	,replaceNodes: function(mathNodes,n,callbackFunc) {
		...
		this.processMathML(mathml,container,callbackFunc);
		var self = this;
		self.replaceNodes(mathNodes,n + 1,callbackFunc);
	}
	...
	,parseElement: function(element,callbackFunc) {
		...
		this.replaceNodes(arr,0,callbackFunc);
	}
	,parseDocument: function() {
		this.parseElement(js.Lib.document,null);
	}
	,doLoad: function() {
