...
<?php 
$hasil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT *,u.XStatusUjian as ujsta FROM cbt_siswa s
...
$var_siswa = "$_REQUEST[siswa]";
	...
	$sqlujian = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `cbt_jawaban` j left join cbt_soal s on s.XNomerSoal = j.XNomerSoal WHERE j.XKodeSoal = '$var_soal' and j.XUserJawab = '$var_siswa'
	and XTokenUjian = '$var_token'");
	
	$sqlmapel = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian c left join cbt_mapel m on m.XKodeMapel = c.XKodeMapel where c.XKodeSoal = '$var_soal'"); 
	$u = mysqli_fetch_array($sqlmapel);
	$namamapel = $u['XNamaMapel'];
	$kodemapel = $u['XKodeMapel'];
	
	$sqlsiswa = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `cbt_siswa` WHERE XNomerUjian= '$var_siswa'");
...
$no = $no +1;
	...
	$sqldijawab = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], " SELECT * FROM `cbt_jawaban` WHERE XKodeSoal = '$var_soal' and XUserJawab = '$var_siswa' and XJawaban = '' and XTokenUjian = '$var_token'"));

$sqljumlah = mysqli_query($GLOBALS["___mysqli_ston"], "select sum(XNilaiEsai) as hasil from cbt_jawaban where XKodeSoal = '$var_soal' and XUserJawab = '$var_siswa' and XTokenUjian = '$var_token'");
$o = mysqli_fetch_array($sqljumlah);

$nilai_esai = $o['hasil'];

$sqljawaban = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT count( XNilai ) AS HasilUjian FROM `cbt_jawaban` WHERE XKodeSoal = '$var_soal' and XUserJawab = '$_REQUEST[siswa]' and XNilai = '1' and XTokenUjian = '$var_token'");
...
$sqljawaban = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT sum( XNilaiEsai ) AS HasilEsai FROM `cbt_jawaban` WHERE XKodeSoal = '$var_soal' and XUserJawab = '$_REQUEST[siswa]' and XJenisSoal = '2' and XTokenUjian = '$var_token'");
	$sqj = mysqli_fetch_array($sqljawaban);
...
$sqlsoal = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$var_soal' and XJenisSoal = '1'")); 
$sqltampil = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XKodeSoal = '$var_soal'"); 
$t1 = mysqli_fetch_array($sqltampil);
$t = $t1['XPilGanda'];

$sqlbenar = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_nilai where XKodeSoal = '$var_soal' and XNomerUjian = '$var_siswa' and XTokenUjian = '$var_token'"); 
$b1 = mysqli_fetch_array($sqlbenar);
$b = $b1['XBenar'];

$tkn = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa_ujian where XKodeSoal = '$var_soal' and XNomerUjian = '$var_siswa'"); 
...
$sqlujian = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian c left join cbt_mapel m on m.XKodeMapel = c.XKodeMapel where c.XKodeSoal = '$var_soal'"); 
...
$sqljur = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `cbt_siswa` WHERE XNomerUjian= '$var_siswa' ");
$sjur = mysqli_fetch_array($sqljur);
$kojur = $sjur['XKodeJurusan'];

$sqlsiswa = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM `cbt_siswa` s left join cbt_kelas k on k.XKodeKelas = s.XKodeKelas WHERE XNomerUjian= '$var_siswa'");
$s = mysqli_fetch_array($sqlsiswa);
$namsis = $s['XNamaSiswa'];
$kokel = $s['XKodeKelas'];
$nomsis = $s['XNIK'];
...
$sqlsoal = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$var_soal'")); 
$sqltampil = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XKodeSoal = '$var_soal'"); 
$t1 = mysqli_fetch_array($sqltampil);
$t = $t1['XJumSoal'];

$sqlbenar = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_nilai where XKodeSoal = '$var_soal' and XNomerUjian = '$var_siswa'"); 
$b1 = mysqli_fetch_array($sqlbenar);
$b = $b1['XBenar'];
...
$jumpil = $r['XJumPilihan'];		
	...
	$sqlpil = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT $PilJwb as pilsoal FROM `cbt_soal` WHERE XKodeSoal = '$var_soal' and XNomerSoal = '$r[XNomerSoal]'");
...
//Soal Pilihan Ganda
$sqlsoal = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$var_soal' and XJenisSoal = '2'")); 
$sqltampil = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XKodeSoal = '$var_soal'"); 
$t1 = mysqli_fetch_array($sqltampil);
//$t = $t1['XJumSoal'];
$t = $t1['XPilGanda'];
