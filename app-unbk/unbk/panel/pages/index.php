				...
				<!-- BEGIN PAGE HEADER-->
                    ...
                    <div class="page-bar">
                        ...
                        <li>
						 ...
						 <small><?php
							if(isset($bread)){
							echo $bread;} ?> | Education Partner</small></span>
                        </li>
...
renderTime();
	...
	<!-- END CONTAINNER 	-->
		...
		<div class="page-footer" style="background-color:#364150">
				...
				<center>
					<font align="center"> UNBK Copyright &copy;&nbsp;2021&nbsp;By &nbsp;
					<a target="_blank" href="http://ubk.kemdikbud.go.id"><?php echo strtoupper($skull); ?></a>
					<a href="https://aries.my.id"></a></font></center>
				</div>
