    ...
    <div id="left" style="float: left; width: 45%; height: 500px; margin-top:10px"> 
       <table border="0" width="90%" align="center">
                        <tr height="40px"><td> Mata Uji </td><td>
                                ...
                                <?php
                                include "../cbt_con.php";
                                $sqlkelas = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_mapel order by XNamaMapel");
                        	...
                        	<tr height="40px"><td> Kelas </td><td>
                                ...
                                include "../cbt_con.php";
                                $sqlkelas = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_kelas where XStatusKelas = '1' order by Urut");
                                while($sk = mysqli_fetch_array($sqlkelas)){
                        	...
                        	<tr height="40px"><td> Grup Soal </td><td>
                                ...
                                $sqltes= mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XStatusKelas = '1' order by XKodeKelas");
                                while($sk = mysqli_fetch_array($sqlkelas)){
