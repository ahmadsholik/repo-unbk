            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <?php $sqlsoalan = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal s left join cbt_mapel m on s.XKodeMapel = m.XKodeMapel 
...
<div class="scroll">
                            <table width="auto" class="table table-striped table-bordered" id="example">
                                <thead>
