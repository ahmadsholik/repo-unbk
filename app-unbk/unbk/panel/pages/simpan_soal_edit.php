...
$sqlcek = mysqli_query($GLOBALS["___mysqli_ston"], "select XGambarTanya,XVideoTanya,XAudioTanya,
...
if($gbr5==""){$gambar5 = $gambar5;} else {$gambar5 = $gbr5;}
 	...
 	$sql0 = mysqli_query($GLOBALS["___mysqli_ston"], "update cbt_soal set XTanya = '$sss', 
