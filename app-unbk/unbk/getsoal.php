...
#slideMenu.closed {right:-900px;}
#slideMenu {position:fixed; right:200px; top:350px; width:900px; height:300px; border-left:0px; background-color:#efefef; z-index:20;}
...
.contente {margin-top:20px; margin-left:20px; margin-bottom:20px; margin-right:20px; width:860px; z-index:20; border-style:solid; border:thin;
	border-color:#ccc; padding:20px; background-color:#FFF; overflow:scroll; height:270px; font:12px/25px Verdana, Arial, Helvetica, sans-serif;}
...
<?php include "config/server.php";
	...
	$sqluser = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa` WHERE XNomerUjian = '$user'");
	$su = mysqli_fetch_array($sqluser);
	$xkelz = $su['XKodeKelas'];
	$xjurz = $su['XKodeJurusan'];  

	$sqlgabung = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa` s LEFT JOIN cbt_ujian u ON (s.XKodeKelas = u.XKodeKelas or u.XKodeKelas = 'ALL') 
	...
	$sqluser = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT u.*,m.XNamaMapel FROM cbt_ujian u LEFT JOIN cbt_paketsoal p on p.XKodeSoal = u.XKodeSoal and p.XKodeMapel = u.XKodeMapel left join cbt_mapel m on u.XKodeMapel = m.XKodeMapel 
		WHERE u.XKodeSoal='$xkodesoal' and u.XStatusUjian = '1'");
	$so = mysqli_fetch_array($sqluser);
	$sopil = $so['XJumPilihan'];
	$listen =$so['XListening'];

	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT j.Urut as Urut, j.XJawaban as XJawaban, j.XJawabanEsai as XJawabanEsai , c.XNomerSoal as XNomerSoal, j.XRagu as XRagu, c.XJenisSoal as XJenisSoal 
...
<?php include "config/server.php";
	...
	$sqlgabung = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa` s LEFT JOIN cbt_ujian u ON (s.XKodeKelas = u.XKodeKelas or u.XKodeKelas = 'ALL') WHERE XNomerUjian = 
		'$user' and (u.XKodeJurusan = '$xjurz' or u.XKodeJurusan = 'ALL') and (u.XKodeKelas = '$xkelz' or u.XKodeKelas = 'ALL') and u.XStatusUjian = '1'");
	$s0 = mysqli_fetch_array($sqlgabung);
	$xkodesoal = $s0['XKodeSoal'];
	$xtokenujian = $s0['XTokenUjian'];  
 
	$sqluser = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT u.*,m.XNamaMapel FROM cbt_ujian u LEFT JOIN cbt_paketsoal p on p.XKodeSoal = u.XKodeSoal and p.XKodeMapel = u.XKodeMapel 
...
if($("#slideMenu").hasClass('closed')){
				$("#slideMenu").animate({center:0}, 200, function(){
...
$("#ahir").css("display", "none");					
			...
			if ( $(window).width() > 739) {      
				$("#slideMenu").animate({center:-400}, 200, function(){// jika screen kecil gunakan right:-240, untuk lebar right:-400
				...
				$("#slideMenu").animate({center:-200}, 200, function(){// jika screen kecil gunakan right:-240, untuk lebar right:-400
					$(this).removeClass('opened').addClass('closed');
					document.getElementById("kakisoal").style.width = '97.7%';
					$("a#toggleLink").removeClass('toggleBtnHighlight').addClass('toggleBtn');
				});
				...
				$("#slideMenu").animate({center:-240}, 200, function(){// jika screen kecil gunakan right:-240, untuk lebar right:-400
					$(this).removeClass('opened').addClass('closed');
					document.getElementById("kakisoal").style.width = '97.7%';
					$("a#toggleLink").removeClass('toggleBtnHighlight').addClass('toggleBtn');
				});
...
$sqlj = mysqli_query($GLOBALS["___mysqli_ston"], "
SELECT * 
FROM cbt_soal s
...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT Urut FROM cbt_jawaban WHERE Urut > '$current_picture' and XKodeSoal = '$xkodesoal'
...
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * 
FROM cbt_soal s
LEFT JOIN cbt_jawaban j ON (j.XNomerSoal = s.XNomerSoal and j.XKodeSoal = s.XKodeSoal)
WHERE j.Urut =  '$_POST[pic]'
AND s.XKodeSoal =   '$xkodesoal'
...
<link type="text/css" rel="stylesheet" href="/css/css/jfontsize.css" />
<link type="text/css" rel="stylesheet" href="css/css/shCoreDefault.css" />
...
$sqlaud = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XKodeSoal = '$xkodesoal' and XTokenUjian = '$xtokenujian' and Urut = '$current_picture'
 and XUserJawab = '$user'");
...
$str = str_replace("'<","`<",$str);
	...
	echo "<center><img src='pictures/$result[XGambarTanya]' width='400px'></center></a><br /><br />";} //perintah tampilakan Soal Gambar dengan lebar dalam pixcel
...
?>
						...
						<div class="modal fade bs-modal-lg in" id="myModalP" role="dialog">
							<div class="modal-dialog modal-lg" style="width:100%"><br><br><br><br><br>
									<div class="col-md-12">
                                                ...
                                                <div class="modal-body" >
													<div class="inner-content">
														<div class="row" style="background-color:#fff">
														   <?php echo "<center><img src='pictures/$result[XGambarTanya]' height='100%'></center></a><br />"; ?>
														</div>
													</div>
												</div>
												<div class="modal-footer">
                                                    <button class="btn btn-danger btn-block" id="lanjut" type="submit" data-bind="click: handleNotConfirm" data-dismiss="modal" aria-hidden="true" >Close</button>
...
<?php
 ...
 $cekesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where Urut='$current_picture' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian' and XUserJawab = '$user' "); 
...
<table border="0" cellpadding="0px" cellspacing="0px">
	<tr><td valign="center"><input id="A" type="radio" name="credit-card" value="A" <?php echo $nilaiA; ?>>
				...
				<div class="modal-dialog" style="width:95%">
					<div class="modal-content">
						...
						<button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Perbesar Gambar A</h4>
                        </div>
						<div class="modal-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
										<?php 	if(str_replace("  ","",$pilgbrA)==''){}else{
												echo "<center><img src='pictures/$pilgbrA' width='100%'></center></a><br />";
										}?>
								</div>
							</div>
						</div>
						<div class="modal-footer">
							<div class="row" style="background-color:#fff">
								<div class="col-xs-6 col-center" style="margin-left:25%">
									<button data-bind="click: handleNotConfirm" type="submit" class="btn btn-danger"  data-dismiss="modal" id="lanjut">Tutup</button></a>
								</div>
						</div>
						</div>
        ...
        <td class="pilihanjawaban" valign="center"><?php echo "$jwbA"; ?></td>
	</tr>
	<tr><td valign="center"><input id="B" type="radio" name="credit-card" value="B" <?php echo $nilaiB; ?>>
			...
			<div class="modal fade" id="myModalB" role="dialog">
				<div class="modal-dialog" style="width:95%">
					<div class="modal-content">
                        <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Perbesar Gambar B</h4>
                        </div>
						<div class="modal-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
									<?php 	if(str_replace("  ","",$pilgbrB)==''){}else{
											echo "<center><img src='pictures/$pilgbrB' width='100%'></center></a><br />"; 
									}?>
								</div>
							</div>
						</div>
        ...
        <td class="pilihanjawaban" valign="center"><?php echo "$jwbB"; ?></td>
	</tr>
	<tr><td valign="center"><input id="C" type="radio" name="credit-card" value="C" <?php echo $nilaiC; ?>>
			...
			<div class="modal fade" id="myModalC" role="dialog">
				<div class="modal-dialog" style="width:95%">
					<div class="modal-content">
                        <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Perbesar Gambar C</h4>
                        </div>
						<div class="modal-body">
							<div class="inner-content">
								<div class="row" style="background-color:#fff">
									<?php 	if(str_replace("  ","",$pilgbrC)==''){}else{
											echo "<center><img src='pictures/$pilgbrC' width='100%'></center></a><br />"; 
									}?>
								</div>
							</div>
						</div>
        ...
        <td class="pilihanjawaban" valign="center"><?php echo "$jwbC"; ?></td>
	</tr>
	<?php if($sopil>3){?>
	<tr><td valign="center"><input id="D" type="radio" name="credit-card" value="D" <?php echo $nilaiD; ?>>
          ...
          <div class="modal fade" id="myModalD" role="dialog">
                    <div class="modal-dialog" style="width:95%">
						<div class="modal-content">
								<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal">&times;</button>
									<h4 class="modal-title">Perbesar Gambar D</h4>
								</div>
                                <div class="modal-body">
                                    <div class="inner-content">
                                        <div class="row" style="background-color:#fff">
                                           ...
                                           echo "<center><img src='pictures/$pilgbrD' width='100%'></center></a><br />"; 
                                           }
                                           ?>
                                        </div>
                                    </div>
        ...
        <td class="pilihanjawaban" valign="center"><?php echo "$jwbD"; ?></td></tr>
		<?php } ?>
		 
        <?php if($sopil>4){?>
  		<tr><td valign="center"><input id="E" type="radio" name="credit-card" value="E" <?php echo $nilaiE; ?> >
          ...
          <div class="modal fade" id="myModalE" role="dialog">
            <div class="modal-dialog" style="width:95%">
					<div class="modal-content">
                        <div class="modal-header">
						<button type="button" class="close" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title">Perbesar Gambar E</h4>
                        </div>
                        <div class="modal-body">
                            <div class="inner-content">
                                <div class="row" style="background-color:#fff">
                                   ...
                                   echo "<center><img src='pictures/$pilgbrE' width='100%'></center></a><br />"; 
                                   }
                                   ?>
                                </div>
                            </div>
        ...
        <td class="pilihanjawaban" valign="center"><?php echo "$jwbE"; ?></td></tr>
        <?php } ?>
...
<div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                    <h4 class="modal-title">Zoom Gambar</h4>
                </div>
                <div class="modal-body">
                    <div class="inner-content">
                        <div class="row" style="background-color:#fff">
...
<div class="kakisoal">
	<section class="page-section soal-navigation">
		<div class="container1" style="margin-right:-70px; margin-left:-20px;">
			<div >
				 <?php 	if($prev_id>0){ 
					echo "<a href='#' data-id='".$prev_id."' class='get_pic' id='tombol'>"; } ?>
						<button id="btnPrevSoal" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-prev" data-bind="click: gotoBack"><img src="images/sebelumnya.png"></button>
					</a>
			</div>
			<?php	if(isset($stu)){ 
						$cek = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where Urut='$stu' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'"); 
			...
			?>
			<div>	<label  class="labele" style="padding-bottom:10px; padding-top:10px; width:250px; border-radius: 30px;">
			...
			<div >
					...
					<?php 	$cekragu = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
							<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR"><img src="images/selesai.png"></button>
					<?php 	} else { ?>  
					...
					<?php 	} echo "</a>";
								...
								<button id="btnNextSoal" class="btn btn-primary btn-next activebutton" data-bind="css: { &#39;activebutton&#39;:(currentNo() &lt; totalQuestions - 1)}, visible: (currentNo() &lt; 
									totalQuestions - 1),click: gotoNext" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;"><img src="images/selanjutnya.png"></button>
					<?php  	} ?>
					<?php 	} else { ?>
			 		<?php	$cekragu = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XRagu ='1' and XKodeSoal ='$xkodesoal' and XTokenUjian = '$xtokenujian'  and XUserJawab = '$user'")); 
							if($cekragu>0){ ?>
								<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModalR"><img src="images/selesai.png"></button>
							<?php } else { ?>  
								<button id="btnSelesai" style="padding-bottom:10px; padding-top:10px; width:225px; border-radius: 30px;" class="btn btn-primary btn-end activebutton" data-toggle="modal" data-target="#myModal2"><img src="images/selesai.png"></button>
							<?php } echo "</a>";  }?>
			</div>
		</div>
	</section>	
    ...
    <div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
                   	...
                   	<h1 class="panel-title page-label" align="center">Konfirmasi Tes</h1>
                   	<button type="button" class="close" data-dismiss="modal">&times;</button>
			</div>
			<div class="mpdal-body">
				<div class="inner-content">
					<div class="row" style="background-color:#fff">
						<div class="col-xs-3">
			...
			<div class="panel-footer">
				<div class="row" style="background-color:#fff">
					<div class="col-xs-6"> 
						<button id="btnLanjut" type="submit" class="btn btn-primary btn-block" disabled onClick="location.href='akhir.php';"  style="border-radius: 30px;"><img src="images/kselesai.png"></button>
					</div>
					<div class="col-xs-6" >
						<button type="submit" class="btn btn-danger btn-block " data-dismiss="modal" style="border-radius: 30px;"><img src="images/tidak.png"></button>
					</div>
				</div>
			</div>
                ...
                <div class="panel-footer">
                    <div class="row" style="background-color:#fff">
                        ...
                        <div class="col-xs-6 col-center" style="margin-left:25%; border-radius: 30px;" >
                            <button data-bind="click: handleNotConfirm" type="submit" class="btn btn-danger btn-block"  data-dismiss="modal" id="lanjut" style="font-family: sans-serif;">LANJUT</button></a>
                        </div>
                    </div>
                </div>
