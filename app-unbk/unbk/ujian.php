...
LEFT JOIN cbt_mapel m on m.XKodeMapel = u.XKodeMapel WHERE s.XNomerUjian = 
 ...
 $sqlIP = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa_ujian` WHERE XNomerUjian = '$user' and XTokenUjian = '$xtokenujian'");
 $ad0 = mysqli_fetch_array($sqlIP);
 $user_ip2 = str_replace(" ","",$ad0['XGetIP']); 
 $sqlIP1 = mysqli_query($GLOBALS["___mysqli_ston"], "update `cbt_siswa_ujian` set XGetIP = '$user_ip' WHERE XNomerUjian = '$user' and XTokenUjian = '$xtokenujian'");

$sqlnk = mysqli_query($GLOBALS["___mysqli_ston"], "SELECT * FROM  `cbt_siswa` WHERE XNomerUjian = '$user'");
$sNK = mysqli_fetch_array($sqlnk);
$NK = str_replace(" ","",$sNK['XNamaKelas']); 
$sqlNKsj = mysqli_query($GLOBALS["___mysqli_ston"], "update `cbt_siswa_ujian` set XNamaKelas = '$NK' WHERE XNomerUjian = '$user' and XTokenUjian = '$xtokenujian'");
...
$sqlceksiswa = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_siswa_ujian where XNomerUjian = '$user' and XKodeSoal = '$xkodesoal' and XTokenUjian ='$xtokenujian' and XSesi ='$xsesi'"); 
...
if($jumsqlceksiswa<1){ // jika siswa belum pernah login 
		...
		$sqlout = mysqli_query($GLOBALS["___mysqli_ston"], "Update cbt_siswa_ujian set XStatusUjian = '9' where XNomerUjian = '$user' and XStatusUjian = '1' and XTokenUjian ='$xtokenujian' and XSesi ='$xsesi'");
		// header('location:logout.php');
		} 
...
$xtgl1 = "$xtgl1 $xjam1";
	...
	$sqlinputsiswa = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_siswa_ujian 
...
if(isset($_COOKIE['PESERTA'])){
$user = $_COOKIE['PESERTA'];
$sql = mysqli_query($GLOBALS["___mysqli_ston"], "Update cbt_siswa_ujian set XLastUpdate = '$tglbalik'  where XNomerUjian = '$user' and XStatusUjian = '1' ");
}
...
<?php 
$cek = mysqli_num_rows(mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_jawaban where XKodeSoal = '$xkodesoal' and XUserJawab = '$user' and XTokenUjian = '$xtokenujian'"));
if($cek<1){  
$hit = 1;


  if($xmapelagama=='Y'){
  $sqlambilsoalpilT1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'T' and XAgama = '$xpilih' order by Urut LIMIT  $xjumpilg");
  }else  if($xmapelagama=='A'){
  $sqlambilsoalpilT1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'T' and XAgama = '$xagama' order by Urut LIMIT  $xjumpilg");
  } else {
  $sqlambilsoalpilT1 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'T' order by Urut LIMIT  $xjumpilg");
  }  
  while($r2=mysqli_fetch_array($sqlambilsoalpilT1)){
	...
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XKunciJawaban,XA,XB,XC,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values 
...
'$xsetidx','$xkodemapel','$xsemester')"); 
	...
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XKunciJawaban,XA,XB,XC,XD,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values 	
...
'$xsetidx','$xkodemapel','$xsemester')"); 
	...
	$sql = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XKunciJawaban,XA,XB,XC,XD,XE,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values 
...
'$xsetidx','$xkodemapel','$xsemester')"); 
  ...
  if($xmapelagama=='Y'){
  $sqlambilsoalpilA2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'A' and XAgama = '$xpilih'
   order by RAND() LIMIT  $jmlpilA");
  }elseif($xmapelagama=='A'){
  $sqlambilsoalpilA2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'A' and XAgama = '$xagama'
   order by RAND() LIMIT  $jmlpilA");
  } else {
  $sqlambilsoalpilA2 = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '1' and XAcakSoal = 'A' order by RAND() LIMIT  $jmlpilA");  
  }
...
//  $xjumlahesai = $s['XEsai'];  
if($xmapelagama=='A'){
  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'T' and XAgama = '$xagama' order by Urut LIMIT $xjumesai");
} 
elseif($xmapelagama=='Y'){
  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'T' and XAgama = '$xpilih' order by Urut LIMIT $xjumesai");
} 
else {
  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'T' order by Urut LIMIT $xjumesai");
}  
  while($r1=mysqli_fetch_array($sqlambilsoalesai)){
	  $sqlsimpanesai = mysqli_query($GLOBALS["___mysqli_ston"], "insert into cbt_jawaban (Urut,XNomerSoal,XUserJawab,XKodeSoal,XTokenUjian,XTglJawab,XJenisSoal,XKodeKelas,XKodeJurusan,XKodeUjian,XSetId,XKodeMapel,XSemester) values 	
  ...
  //ambil acak esai tambahan sebanyak sisa esai
	  ...
	  if($xmapelagama=='Y'){
	  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'A' and XAgama = '$xpilih' order by RAND() 
	  LIMIT $sisaesai");
	  }elseif($xmapelagama=='A'){
	  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'A' and XAgama = '$xagama' order by RAND() 
	  LIMIT $sisaesai");
	  } else {
	  $sqlambilsoalesai = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_soal where XKodeSoal = '$xkodesoal' and XJenisSoal = '2' and XAcakSoal = 'A' order by RAND() LIMIT $sisaesai");
	  }
...
$sqlhd = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_header limit 1");
$hu = mysqli_fetch_array($sqlhd);
$headerujian=$hu['HeaderUjian'];
$xkodesoal = $s['soalz'];
$pdf = mysqli_query($GLOBALS["___mysqli_ston"], "select * from cbt_ujian where XKodeSoal = '$xkodesoal' ");
...
<div class="page-header navbar navbar" style="background-color:#336799 ;">      
                        ...
                        <ul class="nav navbar-nav pull-right">
                            ...
                            <li class="dropdown dropdown-user dropdown-dark">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <span class="username username-hide-on-mobile" id="user"><?php echo "$val_siswa ($kodekelas-$kodejurusan)"; ?></span>
                                    <!-- DOC: Do not remove below empty space(&nbsp;) as its purposely used -->
									<?php 	if(file_exists("fotosiswa/$s[XFoto]")&&!$gambar==''){ ?>
...
<?php } ?>
	    ...
	    <li class="header">
           ...
           <span class="flex-abu1"><a href="javascript:AlertIt();"><img src="images/menu.png" width="95px" height="16px"></a> </span> 
